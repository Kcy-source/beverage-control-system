...
const centerViewStyle=document.createElement("link");centerViewStyle.rel="stylesheet";centerViewStyle.href="./center-view.css?v=20260902m";document.head.appendChild(centerViewStyle);
[
...
].forEach(file=>{const script=document.createElement("script");script.src="./"+file+"?v=20260902m";script.defer=true;document.head.appendChild(script);});
